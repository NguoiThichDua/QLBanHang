        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mt-3 d-flex justify-content-center">
                <a href="index.php?page=quanlikhachhang" class="w-100 text-decoration-none">
                    <div class="card mb-3 border border-white card-index-quanli layer2" style=" border-radius: 50px 50px; box-shadow: 0 15px 25px rgba(0,0,0,.1);">
                        <div class="d-flex justify-content-center ">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mt-3 d-flex justify-content-center">
                <a href="index.php?page=quanlihanghoa" class="w-100 text-decoration-none">
                    <div class="card mb-3 border border-white card-index-quanli layer3" style=" border-radius: 50px 50px; box-shadow: 0 15px 25px rgba(0,0,0,.1);">
                        <div class="d-flex justify-content-center">
