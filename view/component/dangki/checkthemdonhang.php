<?php
   ...
   if(isset($_REQUEST['tentaikhoan'])){
        ...
        if(strlen($tentaikhoan) < 1){
            ...
            if($count >= 1){
                echo "<small style='color: MediumSeaGreen'><b>Bạn có thể thêm đơn hàng cho số điện thoại này</b></small>";
            }else if($count == 0){
                echo "<small style='color: red'><b>Số điện thoại chưa tồn tại - không thể thêm</b></small>";
            }else{
