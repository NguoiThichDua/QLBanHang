...
function checkmatkhau(){
    ...
    if(MatKhauDangKi.length <= 5){
        DoDaiMatKhauDangKi.innerHTML = "<small><b class='text-light'>Độ dài: " + dodai + " <span style='color:red'> (yếu)</span></b><small>";
    }else if(MatKhauDangKi.length > 5 && MatKhauDangKi.length <= 10){
        DoDaiMatKhauDangKi.innerHTML = "<small><b class='text-light'>Độ dài: " + dodai + " <span style='color:orange'> (vừa)</span></b><small>";
    }else if(MatKhauDangKi.length > 10){
        DoDaiMatKhauDangKi.innerHTML = "<small><b class='text-light'>Độ dài: " + dodai + " <span style='color:MediumSeaGreen'> (mạnh)</span></b><small>";
    }
}
